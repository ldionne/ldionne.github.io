...
\section{Experience}
\cventry{2014 (ongoing)}{GSoC student with Boost}{\myhref{http://www.google-melange.com/gsoc/homepage/google/gsoc2014}{Google Summer of Code}}{}{}{
    Work on \myhref{http://github.com/ldionne/hana}{Boost.Hana}
}
...
\section{Talks}
\cventry{2014}
        {\myhref{http://ldionne.github.io/mpl11-cppnow-2014}{Towards painless metaprogramming}}
        {\myhref{http://www.cppnow.org}{C++Now}}{Aspen}{}{}

\cventry{2013}
        {\myhref{http://ldionne.github.io/d2-cppnow-2013}{A system for resource deadlock prevention}}
        {\myhref{http://www.cppnow.org}{C++Now}}{Aspen}{}{}

\cventry{2013}
        {\myhref{http://ldionne.github.io/d2-opencode12}{Deadlock detection with d2}}
        {\myhref{http://www.opencode.ca}{OpenCode \#12}}{Québec}{}{}

\cventry{2013}
        {\myhref{http://docs.google.com/presentation/d/1HpjEz6dJauNoBxMGWzaNuOOoiVwqgISTNWNTwuOo-_8/edit?usp=sharing}{Concept based overloading in C++}}
        {\myhref{http://www.opencode.ca}{OpenCode \#9}}{Québec}{}{}
...
{An experimental C++1y library for heterogeneous computation}{
    Design and implementation of a library to manipulate heterogeneous
    sequences at compile-time or at runtime. The library provides the
    functionality of the Boost.MPL and Boost.Fusion behind a single purely
    functional interface. The C++ type system is also extended with type
    classes inspired by Haskell.}
